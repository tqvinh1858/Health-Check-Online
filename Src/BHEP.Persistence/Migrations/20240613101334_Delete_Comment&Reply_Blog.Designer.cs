...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240613101334_Delete_Comment&Reply_Blog")]
    partial class Delete_CommentReply_Blog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 17, 13, 33, 389, DateTimeKind.Local).AddTicks(1165));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 17, 13, 33, 389, DateTimeKind.Local).AddTicks(1700));
