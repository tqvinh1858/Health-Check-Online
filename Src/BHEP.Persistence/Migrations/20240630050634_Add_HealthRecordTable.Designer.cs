...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240630050634_Add_HealthRecordTable")]
    partial class Add_HealthRecordTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 12, 6, 32, 754, DateTimeKind.Local).AddTicks(8382));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 30, 12, 6, 32, 754, DateTimeKind.Local).AddTicks(8765));
