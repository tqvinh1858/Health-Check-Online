...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240526165516_AddMajorTable")]
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 26, 23, 55, 14, 85, DateTimeKind.Local).AddTicks(7186));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 26, 23, 55, 14, 85, DateTimeKind.Local).AddTicks(7510));
