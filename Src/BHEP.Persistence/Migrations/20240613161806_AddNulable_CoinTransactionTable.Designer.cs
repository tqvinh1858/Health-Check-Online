...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240613161806_AddNulable_CoinTransactionTable")]
    partial class AddNulable_CoinTransactionTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 23, 18, 5, 226, DateTimeKind.Local).AddTicks(988));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 23, 18, 5, 226, DateTimeKind.Local).AddTicks(1336));
