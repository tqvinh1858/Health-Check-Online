...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240610114254_Update_Blog_DeleteBehavior")]
    partial class Update_Blog_DeleteBehavior
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 10, 18, 42, 52, 324, DateTimeKind.Local).AddTicks(3935));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 10, 18, 42, 52, 324, DateTimeKind.Local).AddTicks(4305));
