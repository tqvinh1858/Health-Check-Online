...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240619113525_UpdateConfigCode&CoinTransaction")]
    partial class UpdateConfigCodeCoinTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 19, 18, 35, 24, 252, DateTimeKind.Local).AddTicks(7112));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 19, 18, 35, 24, 252, DateTimeKind.Local).AddTicks(7520));
