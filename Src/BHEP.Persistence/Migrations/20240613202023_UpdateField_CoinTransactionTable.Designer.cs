...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240613202023_UpdateField_CoinTransactionTable")]
    partial class UpdateField_CoinTransactionTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 14, 3, 20, 23, 171, DateTimeKind.Local).AddTicks(8153));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 14, 3, 20, 23, 171, DateTimeKind.Local).AddTicks(8486));
