...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240611050527_Add_Price_In_Appointment")]
    partial class Add_Price_In_Appointment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 12, 5, 25, 471, DateTimeKind.Local).AddTicks(9105));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 12, 5, 25, 472, DateTimeKind.Local).AddTicks(881));
