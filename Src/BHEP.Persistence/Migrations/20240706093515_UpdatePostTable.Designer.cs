...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240706093515_UpdatePostTable")]
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 6, 16, 35, 14, 167, DateTimeKind.Local).AddTicks(1209));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 6, 16, 35, 14, 167, DateTimeKind.Local).AddTicks(1676));
