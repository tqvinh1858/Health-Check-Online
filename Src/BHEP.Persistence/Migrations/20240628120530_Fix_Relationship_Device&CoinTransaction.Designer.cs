...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240628120530_Fix_Relationship_Device&CoinTransaction")]
    partial class Fix_Relationship_DeviceCoinTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 19, 5, 30, 361, DateTimeKind.Local).AddTicks(1782));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 19, 5, 30, 361, DateTimeKind.Local).AddTicks(2355));
