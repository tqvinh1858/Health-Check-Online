...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240712074346_AddCoinTrainSactionType")]
    partial class AddCoinTrainSactionType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.PostEntities.PostSpecialist", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PostId", "SpecialistId");

                    b.HasIndex("SpecialistId");

                    b.ToTable("PostSpecialist", (string)null);
                });
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 12, 14, 43, 44, 842, DateTimeKind.Local).AddTicks(3158));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 12, 14, 43, 44, 842, DateTimeKind.Local).AddTicks(3449));
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.UserEntities.DeletionRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeletionRequest", (string)null);
                });
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.UserEntities.HealthRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Code", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.SaleEntities.CoinTransaction", "Transaction")
                        .WithOne("Code")
                        .HasForeignKey("BHEP.Domain.Entities.SaleEntities.Code", "TransactionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.UserEntities.DeletionRequest", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.UserEntities.User", "User")
                        .WithOne()
                        .HasForeignKey("BHEP.Domain.Entities.UserEntities.DeletionRequest", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.UserEntities.HealthRecord", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.SaleEntities.Device", "Device")
