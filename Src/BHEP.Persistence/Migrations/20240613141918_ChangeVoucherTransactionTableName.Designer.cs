...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240613141918_ChangeVoucherTransactionTableName")]
    partial class ChangeVoucherTransactionTableName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 21, 19, 17, 958, DateTimeKind.Local).AddTicks(8740));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 21, 19, 17, 958, DateTimeKind.Local).AddTicks(9085));
