...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240628114653_Fix_Relationship_Code&CoinTransaction2")]
    partial class Fix_Relationship_CodeCoinTransaction2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 18, 46, 52, 705, DateTimeKind.Local).AddTicks(8927));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 18, 46, 52, 706, DateTimeKind.Local).AddTicks(43));
