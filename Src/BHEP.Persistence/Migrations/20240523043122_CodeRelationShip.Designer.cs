...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240523043122_CodeRelationShip")]
    partial class CodeRelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 11, 31, 19, 560, DateTimeKind.Local).AddTicks(5074));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 11, 31, 19, 560, DateTimeKind.Local).AddTicks(5409));
