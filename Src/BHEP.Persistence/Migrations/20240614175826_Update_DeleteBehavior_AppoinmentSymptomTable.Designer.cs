...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240614175826_Update_DeleteBehavior_AppoinmentSymptomTable")]
    partial class Update_DeleteBehavior_AppoinmentSymptomTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 15, 0, 58, 24, 264, DateTimeKind.Local).AddTicks(9933));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 15, 0, 58, 24, 265, DateTimeKind.Local).AddTicks(253));
