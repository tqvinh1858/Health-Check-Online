...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240613141206_Update_Flow_CoinTransaction&PaymentEntities")]
    partial class Update_Flow_CoinTransactionPaymentEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 21, 12, 6, 248, DateTimeKind.Local).AddTicks(9831));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 13, 21, 12, 6, 249, DateTimeKind.Local).AddTicks(200));
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.CoinTransaction", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.SaleEntities.Code", "Code")
                        .WithOne("Transaction")
                        .HasForeignKey("BHEP.Domain.Entities.SaleEntities.CoinTransaction", "CodeId")
                        .OnDelete(DeleteBehavior.NoAction);
