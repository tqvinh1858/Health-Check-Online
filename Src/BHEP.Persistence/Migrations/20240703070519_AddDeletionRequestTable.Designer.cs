...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240703070519_AddDeletionRequestTable")]
    partial class AddDeletionRequestTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 3, 14, 5, 17, 701, DateTimeKind.Local).AddTicks(3581));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 7, 3, 14, 5, 17, 701, DateTimeKind.Local).AddTicks(4810));
