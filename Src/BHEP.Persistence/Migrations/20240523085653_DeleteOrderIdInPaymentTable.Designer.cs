...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240523085653_DeleteOrderIdInPaymentTable")]
    partial class DeleteOrderIdInPaymentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 15, 56, 52, 784, DateTimeKind.Local).AddTicks(326));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 15, 56, 52, 784, DateTimeKind.Local).AddTicks(673));
