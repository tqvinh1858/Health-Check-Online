...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240525041522_AddProfileTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 25, 11, 15, 20, 950, DateTimeKind.Local).AddTicks(6043));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 25, 11, 15, 20, 950, DateTimeKind.Local).AddTicks(6521));
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.UserCode", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.WorkProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Order", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.Code", "Code")
                        .WithOne("Order")
                        .HasForeignKey("BHEP.Domain.Entities.Order", "CodeId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.WorkProfile", b =>
                {
                    b.HasOne("BHEP.Domain.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("BHEP.Domain.Entities.WorkProfile", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
