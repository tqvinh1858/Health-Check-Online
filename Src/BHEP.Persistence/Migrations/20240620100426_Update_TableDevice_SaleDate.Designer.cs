...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240620100426_Update_TableDevice_SaleDate")]
    partial class Update_TableDevice_SaleDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 20, 17, 4, 25, 988, DateTimeKind.Local).AddTicks(7695));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 20, 17, 4, 25, 988, DateTimeKind.Local).AddTicks(8079));
