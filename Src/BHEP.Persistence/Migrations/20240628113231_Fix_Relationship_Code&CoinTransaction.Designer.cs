...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240628113231_Fix_Relationship_Code&CoinTransaction")]
    partial class Fix_Relationship_CodeCoinTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 18, 32, 29, 844, DateTimeKind.Local).AddTicks(6788));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 28, 18, 32, 29, 844, DateTimeKind.Local).AddTicks(7120));
