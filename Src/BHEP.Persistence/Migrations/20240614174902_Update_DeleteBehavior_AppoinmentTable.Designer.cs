...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240614174902_Update_DeleteBehavior_AppoinmentTable")]
    partial class Update_DeleteBehavior_AppoinmentTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.SaleEntities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 15, 0, 49, 1, 23, DateTimeKind.Local).AddTicks(322));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 6, 15, 0, 49, 1, 23, DateTimeKind.Local).AddTicks(835));
