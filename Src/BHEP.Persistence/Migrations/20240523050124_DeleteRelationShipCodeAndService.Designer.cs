...
namespace BHEP.Persistence.Migrations
{
    ...
    [Migration("20240523050124_DeleteRelationShipCodeAndService")]
    partial class DeleteRelationShipCodeAndService
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BHEP.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 12, 1, 22, 311, DateTimeKind.Local).AddTicks(1942));
                    ...
                    b.Property<DateTime>("UpdatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 23, 12, 1, 22, 311, DateTimeKind.Local).AddTicks(2705));
